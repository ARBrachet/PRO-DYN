...
class FEDformer_PRO(nn.Module):
    ...
    def __init__(self, configs, version='fourier', mode_select='random', modes=32):
        ...
        """
        super(FEDformer_PRO, self).__init__()
        ...
        self.linear_PRO = nn.Linear(self.seq_len, self.seq_len)
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # ADDED LINEAR PRO LAYER
        x_enc = self.linear_PRO(x_enc.permute(0,2,1)).permute(0,2,1)
