...
class Crossformer_post_DYN(nn.Module):
    """
    Paper link: https://openreview.net/pdf?id=vSVLM2j9eie
    """
    def __init__(self, configs):
        super(Crossformer_post_DYN, self).__init__()
        ...
        self.pad_in_len = ceil(1.0 * configs.pred_len / self.seg_len) * self.seg_len
        ...
        # Embedding
        self.enc_value_embedding = PatchEmbedding(configs.d_model, self.seg_len, self.seg_len, self.pad_in_len - configs.pred_len, 0)
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # ADDED LINEAR DYN LAYER
        x_enc = self.linear_DYN(x_enc.permute(0, 2, 1)).permute(0, 2, 1)
